...
for item in daily_transactions:
    ...
    daily_transactions_split.append(item_splitted)
...
for item in daily_transactions_split:
  ...
  for new_item in item:
    item_space=new_item.replace("\n","").strip(" ")
    transaction_clean.append(item_space)
...
for color in colors:
  print("Thread Shed sold {total} threads of {color} thread today".format(total=color_count(color), color=color))